        ...
        <div className="container mx-auto flex items-center justify-between h-16 md:h-20 px-4 md:px-8">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.97 }}
              className="ml-2 inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2 text-sm font-medium text-primary-foreground hover:shadow-lg transition-shadow"
